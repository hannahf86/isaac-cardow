          ...
          <div className={styles.mobileNewsCard}>
            ...
            <div className={styles.newsDescription}>
              <p>
                ...
                <br />
                <br />
                He played the very exciting Mazurka Appasionata by Barrios, that
                demonstrates some virtuosic passages and large stretches!
                <br />
                <br />
                Ana was very complimentary and worked on phrasing and character.
                <br />
                <br />
                Thank you very much to IGF for the opportunity!
              </p>
            </div>
          </div>
        </div>
