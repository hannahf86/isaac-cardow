const Calendar = () => {
  const styles = {
    ...
    mobileTitle:
      "text-neutral-100 text-5xl text-center py-12 lg:pt-52 tracking-widest",
    eventCard:
      "flex flex-col bg-neutral-200 w-11/12 m-auto max-w-3xl px-6 py-4 border-4 border-sky-800 lg:text-center lg:w-9/12",
  ...
  return (
    <div id="calendar" className={styles.background} aria-label="calendar">
      ...
      <div className={styles.eventCard}>
        ...
        <p className={styles.eventDescription}>
          This is not a ticketed event, but it is advised to get there in plenty
          of time.
        </p>
        <p className={styles.eventDescription}>
          <br />
          Entry to the event is off the main road, Bootham, not through the
          school
        </p>
        ...
        <p className={styles.eventDescription}>
          <br />
          Parking is available but limited. Please respect the residents space.
        </p>
        <div className="my-4 m-auto">
          _______________________________________
        </div>
        ...
        <h3 className={styles.eventTitle}>
          Mrs Sunderland Performing Arts Festival
        </h3>
        <h3 className={styles.eventDate}>February 2024</h3>

        <h3 className={styles.competitionInfo}>Info</h3>
        <p className={styles.eventDescription}>
          Tickets can be booked online or bought on the door.
        </p>
        <div className="my-4 m-auto">
          _______________________________________
        </div>
        ...
        <h2 className={styles.eventTypeCompetition}>Competition</h2>
        <h3 className={styles.eventTitle}>
          Harrogate Competitive Fesitval for Music
        </h3>
        <h3 className={styles.eventDate}>March 2024</h3>
