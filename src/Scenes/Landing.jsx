...
const Landing = () => {
    ...
    const styles = {
        ...
        mobileSubtitle: 'text-sky-800 font-bold text-center tracking-widest text-2xl pb-12 pt-6 ',
        ...
        tabletSubtitle: 'text-sky-800 font-bold text-center tracking-widest text-3xl pb-12 pt-6 pl-8',
        tabletImage: 'w-6/12 sm:w-7/12 m-auto mb-8',

        desktopContainer: 'hidden lg:block  pt-56 mx-24 lg:grid grid-cols-2 grid-rows-2',
        ...
        desktopBio: 'w-10/12 text-zinc-200 text-xl lg:col-start-2 lg:row-start-2 self-auto pt-8',
    }
        ...
        <div id='/' className={styles.background}>
            ...
            <div id='moblile-landing' className={styles.mobileContainer}>
                ...
                <div className={styles.imageContainer}>
                    <img
                        src={isaac}
                        alt='Isaac Cardow, Classical Guitarist'
                    />
                </div>

                <div className={styles.bio}>
                    <p>Isaac is a talented and engaging classical guitarist, working towards his auditions and future
                        performances...</p>
                </div>

                <a href='/#about'><HiChevronDown size={30} color='white' className={styles.more} /></a>
            </div>
            ...
            <div id='desktop-landing' className={styles.desktopContainer}>
                ...
                <div className={styles.desktopBio}>
                    <p>Isaac is a talented, engaging and award winning classical guitarist, working towards his future studies and career in music.
                        <br /><br />Read more about Isaac and where you can see him live below.</p>
                </div>
